...
public class DBTest extends Activity
{
    ...
    private void inflateList(Cursor cursor)
    {
        ...
        SimpleCursorAdapter adapter=new SimpleCursorAdapter(DBTest.this,R.layout.mytextview,cursor,new String[]{"news_title","news_content"},new int[]{R.id.my_title,R.id.my_content},CursorAdapter.FLAG_REGISTER_CONTENT_OBSERVER);
        //显示数据
